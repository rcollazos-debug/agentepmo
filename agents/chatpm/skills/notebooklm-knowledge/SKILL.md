...
## Integración con ChatPM

Este skill usa el MCP `notebooklm-mcp-cli` que debe estar configurado en el archivo de configuración de ChatPM.

**Configuración en el archivo de config de ChatPM:**
```json
{
  "mcp": {
    "notebooklm": {
      "type": "local",
      "command": ["/Users/rcollazos/.local/bin/notebooklm-mcp"],
      "enabled": true
    }
  }
}
...
3. Agregar la configuración MCP en ChatPM
