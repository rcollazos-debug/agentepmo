...
> **OBLIGATORIO:** Leer `{{AGENT_HOME}}/vorkan/knowledge/vortexbird-brand.md` ANTES de generar cualquier presentación.
...
1. Leer `{{AGENT_HOME}}/vorkan/knowledge/vortexbird-brand.md` → cargar paleta de colores y reglas de logo
2. Verificar que existe `{{AGENT_HOME}}/vorkan/assets/logo-vortexbird.png`
3. Leer `project.md` → obtener `{project_path}` y `{project_name}`

### Paso 1 — Leer fuentes de información (en orden)

1. `{project_path}/context/proyecto-base.md` — datos básicos del proyecto
2. `{project_path}/context/stakeholders.md` — equipo y stakeholders
3. `{project_path}/context/restricciones.md` — scope y restricciones
4. `{project_path}/data/cronograma.md` — hitos y cronograma
5. `{project_path}/data/presupuesto.md` — presupuesto
6. `{project_path}/risks/risk-register.md` — riesgos principales
7. `{project_path}/data/acta-inicio.md` — plantilla de charter
