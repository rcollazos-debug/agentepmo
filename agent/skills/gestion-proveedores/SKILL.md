...
| L3 — Escalación gerencial | Patrón confirmado o impacto en hitos | Carta formal + reunión con dirección del proveedor + activar `{{AGENT_HOME}}/vorkan/playbooks/proveedor-incumplido` |
