...
| `{{AGENT_HOME}}/vorkan/playbooks/recuperacion-proyecto.md` | Si el riesgo ya se materializó |
| `{{AGENT_HOME}}/vorkan/playbooks/presupuesto-critico.md` | Si el riesgo afecta margen financiero |
